...
// This file should contain all of the point reward values for various actions, so that we can see them all
// in one place and tweak them en masse easily.
...
const TamaEggPurchaseBaseCost float64 = 100
