...
**“Software”** means the source code, object code, documentation, and any other materials contained in this repository.

**“Licensor”** means the individual or legal entity that owns the copyright to the Software and grants the license under this License, currently Johnathan Baird.

**“You”** means any individual or legal entity that accesses, uses, copies, modifies, or distributes the Software **in source or compiled form**.

For clarity, **“You” does not include end users who interact with a running instance of the bot solely through Discord or other user-facing interfaces**, and who do not access or interact with the Software’s source code.

**“Noncommercial”** means not primarily intended for or directed toward commercial advantage or monetary compensation.

**“Competing Use”** means operating, providing, or distributing a Discord bot or similar service that is functionally similar to the Software, whether public or private, and whether monetized or not.

**“Contribution”** means any original work of authorship intentionally submitted to this repository for inclusion in the Software, including but not limited to source code, documentation, tests, or other materials. For avoidance of doubt, **purely mechanical or non-creative changes** (such as file moves, formatting changes, or dependency updates without substantive logic changes) are not considered standalone Contributions.

---

## 2. License Grant

Subject to the terms and conditions of this License, the Licensor grants You a worldwide, royalty-free, non-exclusive license to:
...
In the event of any conflict between an individual contributor’s copyright interests and the terms of this License, **the terms of this License shall govern** with respect to use, distribution, and derivation of the Contribution within or from this Software.
...
This License shall be governed by the laws of the Licensor’s jurisdiction.
